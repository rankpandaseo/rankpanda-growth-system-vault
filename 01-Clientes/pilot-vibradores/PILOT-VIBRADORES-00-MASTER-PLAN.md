...
4. Mapear evergreen collections (conteúdo de longo prazo) **Deliverable:** `/01-Clientes/pilot-vibradores/01-keyword-research.md`
...
- Alinhamento formal
- Baseline metrics (GSC coverage, GA4 setup)
- Definição de KPIs (top 10 posição para X keywords)
- Setup ClickUp + Discord **Deliverable:** Kickoff briefing ### FASE 1 — Diagnostic (7-10D)
- Análise técnica (schema, core web vitals, indexation)
- Análise semântica (keyword clustering)
- Análise competitiva (top 3 competitors)
- Opportunity map (3-5 collections prioritárias) **Deliverable:** Diagnostic brief + recomendações ### FASE 2 — Execution (10-14D)
- Optimização de colecções (H1, meta desc, intro, schema)
- Otimização de produtos (titles, descriptions, tags)
- Technical setup (IndexNow, sitemaps, canonicals)
- Internal linking (breadcrumbs, related products) **Deliverable:** 100% das collections otimizadas ### FASE 3 — Validation (7-10D)
- Metrics comparison (indexed pages, impressions, posição)
- Identify new keywords ranking (top 30)
- Document learnings (pepitas de ouro)
- 6-month roadmap (link building, content, evolution) **Deliverable:** Final presentation + roadmap --- ## 📈 PLANO 6 MESES (SEMANAS 8+) **Objectivo:** Evolução estratégica pós-45D ### Mês 2-3: Pilar 2 — Authority
- Link building strategy (5-10 backlinks de qualidade)
- Guest posting (3-5 articles)
- Authority positioning (thought leadership) ### Mês 4-5: Pilar 3 — Content
- Blog strategy (10-15 posts)
- Product content evolution (detailed buying guides)
- FAQ expansion ### Mês 6: Optimization Loop
- Schema markup refinement
- User behavior optimization (bounce rate, time-on-page)
- A/B testing (titles, descriptions, CTA) --- ## 📊 KPIs — O que Medimos **FASE 0 baseline (DIA 7):**
- Indexed pages: X
- Impressões (GSC): X
- Posição média: N/A (sem tráfego ainda) **Target pós-45D (DIA 45):**
- Indexed pages: +200% (baseline pode ser baixo)
- Impressões: +500-1000% (de 0 para X)
- Posição: 3-5 keywords em TOP 10
- Tráfego orgânico: primeiros sessions **Target pós-6M:**
- 20-50 keywords em TOP 30
- 5-10 keywords em TOP 10
- 500+ organic sessions/mês
- 20%+ organic conversion rate (relativo a goal) --- ## 📁 Ficheiros Entregáveis ```
...
└── metrics/ ├── baseline.json (DIA 7) ├── fase-1.json (DIA 17) ├── fase-2.json (DIA 31) └── fase-3.json (DIA 52 — final)

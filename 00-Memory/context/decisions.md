...
## 1. APIs Diretas, Nunca MCP (2026-04-18)

**Decisão:** Todas as integrações via API diretas (Shopify, GSC, GA4, SE Ranking, ClickUp, Gmail, Calendar, Drive, Leexi). NUNCA via MCP.

**Razão:** 
- APIs dão acesso direto às credenciais do Rui (já estão no GitHub rankpandaseo/rankpanda-vault)
- MCP adicionaria complexidade desnecessária
- Performance e agilidade são críticos
...
- Métricas diárias são puxadas automaticamente (GSC, GA4, Shopify)

---

## 2. 45D Sprint como Unidade de Execução (2026-04-18)

**Decisão:** Cada cliente passa por um 45D Sprint estruturado em 4 FASES:
...
- Gera métricas mensuráveis (antes/depois)
...
- ROI calculado no fim (FASE 3)

---

## 3. Vault como Fonte de Verdade (2026-04-18)

**Decisão:** O vault (GitHub) é a source-of-truth para SOPs, templates, course material, e decisões.
...
- Suporta evolução contínua (lições alimentam SOPs)
...
- Cada commit documenta evolução do sistema

---

## 4. Scaffold Automático para Novos Clientes (2026-04-18)

**Decisão:** Quando um cliente entra, um script automático:
...
6. Cria primeira entrada em `memory/sessions/estado-atual.md`
...
- Mensagem confirma Rui: "Cliente [nome] onboarded. [N] fields pendentes para validação."

---

**Próxima revisão:** Após Sprint 001 — Vibradores (FASE 3)

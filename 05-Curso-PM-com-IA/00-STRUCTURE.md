# Course Structure — PM RankPanda com IA

Auto-generated course that grows with every sprint execution.
...
| [1.4](M01-Fundamentos/1.4-Por-que-vence-agencias-tradicionais.md) | 20 min | ✅ Por que este framework vence os 6 meses de agência tradicional |

### M02 — Memória e Contexto: Como Claude Code Sempre Sabe (60 min)
| Lição | Duração | Tema |
|-------|---------|------|
...
| [2.4](M02-Memoria-e-Contexto/2.4-Evitando-alucinacoes.md) | 15 min | ⏳ Evitando Alucinações com Contexto Estruturado |
...
| [3.4](M03-Integrações/3.4-Discord-Shopify-output.md) | 13 min | ⏳ Discord + Shopify: Output e Monitorização |
...
| [4.4](M04-Gestao-de-Equipa/4.4-Detectando-bottlenecks.md) | 11 min | ⏳ Detectando Bottlenecks em Tempo Real |
...
| [5.4](M05-Automacoes-e-Agents/5.4-Debugging-automations.md) | 10 min | ⏳ Debugging Automations (quando dá erro?) |
...
| [6.4](M06-Vault-e-Sync/6.4-Recovering-disaster.md) | 11 min | ⏳ Recovering from Disaster (Git revert, restore) |
...
| [7.4](M07-Reporting-e-Dashboards/7.4-Contando-historia.md) | 11 min | ⏳ Contando a História (dados → narrativa) |
...
| [8.4](M08-Qualidade-e-Anti-Padroes/8.4-Checklist-qualidade.md) | 10 min | ⏳ Checklist de Qualidade (antes de apresentar cliente) |
...
| [9.4](M09-Scaling-e-Sistemas/9.4-Dashboard-escalabilidade.md) | 11 min | ⏳ Dashboard de Escalabilidade (métricas de health) |
...
| [10.4](M10-Bonus-Infraestrutura/10.4-Monitoring-24-7.md) | 11 min | ⏳ Monitoring 24/7 (health checks, alertas) |

## Pepitas de Ouro

File: `pepitas-de-ouro.md`

Auto-generated from real sprint execution:
...
1. **During sprint execution** → Learnings captured in Vault comments
2. **End of each phase** → Claude synthesizes learnings into lesson drafts
3. **After complete sprint** → New pepita(s) de ouro created
4. **Quarterly review** → Course modules updated with new patterns
...
- **Pepitas de Ouro:** 📝 10 captured from M01, growing with execution

**Total Course:** 570 minutes (9.5 hours), 61 lessons across 10 modules
